...
const testObject=ref([
  ...
  {
    _id: "645633fc9e36ac8d9795544c",
    name: "Unterfirmen",
    type: "Object",
    arrayOption: [],
    objectEntries: [
        {
        name:"Geschäftszeweig",
        type: "String",
        arrayOption: [],
        objectEntries: [
            {
